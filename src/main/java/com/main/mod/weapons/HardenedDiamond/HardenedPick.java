...
/**
 * Created by Brandon Boyd on 1/1/15-3:23 PM Project Name: MegaOre Mod.
 */
public class HardenedPick extends ItemPickaxe{
    public HardenedPick(Item.ToolMaterial toolMaterial) {
        super(toolMaterial);
