...
/**
 * Created by Brandon Boyd on 1/1/15-3:03 PM Project Name: MegaOre Mod.
 */
public class NickelAxe extends ItemAxe{
    public NickelAxe(Item.ToolMaterial toolMaterial) {
        super(toolMaterial);
