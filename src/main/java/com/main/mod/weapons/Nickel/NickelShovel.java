...
/**
 * Created by Brandon Boyd on 1/1/15-3:04 PM Project Name: MegaOre Mod.
 */
public class NickelShovel extends ItemSpade{
    public NickelShovel(Item.ToolMaterial toolMaterial) {
        super(toolMaterial);
