...
/**
 * Created by Brandon Boyd on 1/1/15-3:02 PM Project Name: MegaOre Mod.
 */
public class NickelPick extends ItemPickaxe {
    public NickelPick(Item.ToolMaterial toolMaterial) {
        super(toolMaterial);
