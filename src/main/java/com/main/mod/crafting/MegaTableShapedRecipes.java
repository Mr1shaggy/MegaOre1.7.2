...
public class MegaTableShapedRecipes implements IRecipe
{
    ...
    public MegaTableShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public MegaTableShapedRecipes func_92100_c()
    {
